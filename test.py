...
face_data = facedetect =cv2.CascadeClassifier('face_detec\data\haarcascade_frontalface_default.xml')
...
imgBackground = cv2.imread("face_detec\Add a hhiii eading.png")
